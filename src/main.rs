//! Pact plugin for Server-Sent Events.
//!
...
use pact_sse_plugin::proto::pact_plugin_server::PactPluginServer;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    // Setup the logging system based on LOG_LEVEL or PACT_LOGLEVEL environment variable
    ...
    // Setup tracing
    let formatting_layer = BunyanFormattingLayer::new("pact-sse-plugin".into(), json_non_blocking);
